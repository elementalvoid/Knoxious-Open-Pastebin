			...
			echo "<ul id=\"installList\">";
				...
				if(count($stage) > 4) {
					if($CONFIG['pb_rewriteauto']) {
						...
						echo "<span class=\"success\">Masdasd.</span>";
						...
						} ELSE IF($_SERVER['SERVER_SOFTWARE']=="Apache2/Httpd2") {
							//unfinished, someone with apache do this or give me (shadowmajestic) the replies for $_SERVER['SERVER_SOFTWARE'] from apache/httpd2
						}
